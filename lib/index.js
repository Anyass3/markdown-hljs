(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    const runMethods = (funcs, md) => {
        return funcs.reduce((result, fn) => {
            return fn(result);
        }, md);
    };
    const setupVariables = (md) => {
    ...
    const { runMethods: runMethods$1, setupVariables: setupVariables$1 } = utils, methods = __rest(utils, ["runMethods", "setupVariables"]);
    var marked$1 = (markdown) => {
        markdown = setupVariables$1(markdown);
        markdown = marked(markdown);
        markdown = runMethods$1(Object.values(methods), markdown);
        return markdown;
    };
    ...
    */
    ...
    var index = (markdown) => {
        const markedDown = marked$1(markdown);
        return Highlight(markedDown);
    };

    exports.Highlight = Highlight;
    exports.default = index;
    exports.marked = marked$1;
